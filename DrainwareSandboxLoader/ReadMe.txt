========================================================================
    BIBLIOTECA DE VÍNCULOS DINÁMICOS: DrainwareSandboxLoader 
                                      Información general del proyecto
========================================================================

AppWizard ha creado este archivo DLL DrainwareSandboxLoader.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación DrainwareSandboxLoader.


DrainwareSandboxLoader.vcxproj
...
DrainwareSandboxLoader.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado DrainwareSandboxLoader.pch y un archivo de tipos 
