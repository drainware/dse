========================================================================
    BIBLIOTECA DE VÍNCULOS DINÁMICOS: HeapLocker64 
                                      Información general del proyecto
========================================================================

AppWizard ha creado este archivo DLL HeapLocker64.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación HeapLocker64.


HeapLocker64.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado HeapLocker64.pch y un archivo de tipos 
