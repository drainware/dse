========================================================================
    BIBLIOTECA DE VÍNCULOS DINÁMICOS: DrainwarePrintersMonitor 
                                      Información general del proyecto
========================================================================

AppWizard ha creado este archivo DLL DrainwarePrintersMonitor.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación DrainwarePrintersMonitor.


DrainwarePrintersMonitor.vcxproj
...
DrainwarePrintersMonitor.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado DrainwarePrintersMonitor.pch y un archivo de tipos 
