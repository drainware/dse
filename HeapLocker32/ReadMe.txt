========================================================================
    BIBLIOTECA DE VÍNCULOS DINÁMICOS: HeapLocker32 
                                      Información general del proyecto
========================================================================

AppWizard ha creado este archivo DLL HeapLocker32.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación HeapLocker32.


HeapLocker32.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado HeapLocker32.pch y un archivo de tipos 
